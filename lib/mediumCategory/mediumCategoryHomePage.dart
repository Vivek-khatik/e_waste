...
class MymediumCategoryHomePage extends StatelessWidget {
  const MymediumCategoryHomePage({super.key});
          ...
          children: [
            ...
            GestureDetector(
              ...
              child:Row(
                children: [
                  Container(
                    child: Image(image: AssetImage("assets/mediumCategory/chart.png"),
                      width:110,
                      height: 80,
                    )
                  ),
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, 'earphoneCompany');
              },
              child:Container(
              color: Colors.white,
              height: 100,
