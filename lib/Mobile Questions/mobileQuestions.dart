...
class MyMobileQuestionWidget extends StatefulWidget {
  
  String imgAddress="";
  String mbName="";
  int fixedPrice=0;
  MyMobileQuestionWidget(this.imgAddress,this.mbName,this.fixedPrice);

  @override
  State<MyMobileQuestionWidget> createState() => _MyMobileQuestionWidgetState();
}

enum Working {Yes, No}

class _MyMobileQuestionWidgetState extends State<MyMobileQuestionWidget> {
        ...
        child: Column(
          children: [
            ...
            Container(
              child:Column(
              children:[ Container(
                child: Text("Is Battery in Good Condition?"),
              ),
              Row(
                children: [
                  Expanded(
                  ...
                  children: [
                    Expanded(
                      child: RadioListTile<Working>(
                        ...
                        dense: true,
                        title: Text(Working.Yes.name),
                        groupValue: _workingcamera, 
                        onChanged: (value){
                          setState((){
                            _workingcamera=value;
                          });
                        }
                      ),
                    ),
            ...
            onPressed: (){
              ...
              if(_workingdisplay == null || _workingbattery == null || _workingcamera == null || _dentOnScreen == null || _availbb ==null ){
              ...
              setState(() {
                if(_workingdisplay.toString()=="Working.No"){
                  //cal_fixedPrice-=3000;
                  cal_fixedPrice -= (cal_fixedPrice*20~/100).toInt();
                }
                if(_workingbattery.toString()=="Working.No"){
                  //cal_fixedPrice-=1500;
                  cal_fixedPrice -= (cal_fixedPrice*8~/100).toInt();
                }
                if(_workingcamera.toString()=="Working.No"){
                  cal_fixedPrice -= (cal_fixedPrice*25~/100).toInt();
                }
